...
# API views (to handle GET/POST/etc.)
# Authentication & permissions
# Automatic browsable web API interface
...
RAZORPAY_KEY_ID = "rzp_test_yvzRMx05fGPVvq"
RAZORPAY_KEY_SECRET ="ZDRQM8BJnBlWL1YesQqYEEMG"
