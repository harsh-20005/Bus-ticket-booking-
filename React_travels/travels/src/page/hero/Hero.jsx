        ...
        <div className="flex-1 w-full flex items-stretch justify-between gap-12 pb-10">
            ...
            transition={{duration:0.5,ease:"linear",delay:0.2}}>
                ...
                transition={{duration:1,ease:"linear",delay:0.2}}>
                    ...
                    <motion.p className='text-7xl font-normal text-neutral-300 line-clamp-3 text-ellipsis'
                    initial={{opacity:0,y:-10}}
                    animate={{opacity:1,y:0}}
                    transition={{duration:2,ease:"linear",delay:0.6}}>
                        Find and book your bus tickets with just a few clicks.
                        We offer a wide range of bus routes and schedules to suit your needs.
                    </motion.p>

                </motion.div>

                <motion.button  onClick={onClickHandler} className='w-fit bg-violet-700 hover:bg-violet-800 text-neutral-50 font-medium py-3 px-6 rounded-md ease-in-out duration-300'>
                    Reserve Seat Now
                </motion.button>
