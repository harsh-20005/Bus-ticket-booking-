...
const Footer = () => {
  return (
    <footer className="w-full lg:px-28 md:px-16 sm:px-7 px-4 py-8 bg-neutral-200/60 ">
      <div className="grid grid-cols-5 gap-5">
        ...
        <div className="space-y-7">
          ...
          <ul className="space-y-2 text-neutral-600 dark:text-neutral-500 text-base font-normal">
            ...
            <li>
              <Link to="/services" className='hover:text-violet-600 ease-in-out duration-300'>Contact Us</Link>
            </li>
            <li>
        ...
        <div className="space-y-7">
          ...
          <ul className="space-y-2 text-neutral-600 dark:text-neutral-500 text-base font-normal">
            ...
            <li>
              <Link to="/bus" className='hover:text-violet-600 ease-in-out duration-300'>Luxury Buses</Link>
            </li>
            <li>
              <Link to="/servive" className='hover:text-violet-600 ease-in-out duration-300'>Enough Facilities</Link>
            </li>
          </ul>
        </div>
