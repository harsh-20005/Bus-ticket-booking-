    ...
    for (let i = 1; i <= totalSeat; i++) {
      seats.push(
        <Seat
          key={i}
          seatNumber={i}
          isSelected={selectedSeat.includes(i)}
          ...
          <div className="w-full flex-1 flex gap-x-5 items-stretch">
            ...
            <div className="flex flex-col items-center">
              <div className="flex-1 space-y-4">
                ...
                <div className="w-full grid grid-cols-10 gap-x-3">{seats.slice(20, 21)}</div>
                <div className="w-full grid grid-cols-10 gap-x-3">{seats.slice(21, 31)}</div>
                <div className="w-full grid grid-cols-10 gap-x-3">{seats.slice(31, 41)}</div>
              </div>
            </div>
          </div>
        </div>
